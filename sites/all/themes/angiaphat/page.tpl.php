...
<header>
    <div id="stuck_container" style="position: relative; top: 0px;">
        <div class="container">
            <div class="row">
                <div class="grid_12">
                    <h1>
...
<div class="<?php print getBackground(); ?>">
    <div class="container">
        <div class="row">
            <div class="grid_12">
...
<div class="content">
    <div class="container">
        <div class="row">
            <?php if ($breadcrumb): ?>
                <div style="display: none;" id="breadcrumb"><?php print $breadcrumb; ?></div>
            <?php endif; ?>
            ...
            <div <?php if ($page['sidebar_second']): ?> class="grid_8" <?php else: ?> class="grid_12" <?php endif; ?>>
                <a id="main-content"></a>
                ...
                <?php if (1 != theme_get_setting('hide_content_in_front') || !drupal_is_front_page()): ?>
