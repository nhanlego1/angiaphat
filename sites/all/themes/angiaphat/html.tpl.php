...
<head profile="<?php print $grddl_profile; ?>">
    ...
    <![endif]-->
    <!--[if lt IE 9]>
    <script src="/<?php print drupal_get_path('theme','angiaphat') ?>/js/html5shiv.js"></script>
    <link rel="stylesheet" media="screen" href="/<?php print drupal_get_path('theme','angiaphat') ?>/css/ie.css">
