...
<form id="bookingForm" action="/ticket/checking">
  ...
  <div class="province active" style="display: none;position: absolute; left: 970.5px; top: 634px;">
    <a href="javascript:;" class="pull-right province-close"><i class="fa fa-times"></i></a>
      ...
      <div class="panel-body">
        <div class="list clearfix menu-province">
          <ul class="col">
            ...
            <li><a data-city-code="HUI" data-city-index="0" href="#">Huế <span>(HUI)</span></a></li>
            ...
            <li><a data-city-code="BMV" data-city-index="0" href="#">Buôn Ma Thuột <span>(BMV)</span></a></li>
          ...
          <ul class="col">
            ...
            <li><a data-city-code="AYQ|AYQ" data-city-index="16" href="#">Ayers Rock (Uluru) <span>(AYQ)</span></a></li>
            ...
            <li><a data-city-code="OOL" data-city-index="22" href="#">Gold Coast <span>(OOL)</span></a></li>
            <li><a data-city-code="HTI|HTI" data-city-index="23" href="#">Hamilton Island <span>(HTI)</span></a></li>
            ...
            <li><a data-city-code="MCY" data-city-index="33" href="#">Sunshine Coast <span>(MCY)</span></a></li>
          ...
          <ul class="col">
            ...
            <li><a data-city-code="PNH" data-city-index="37" href="#">Phnom Penh <span>(PNH)</span></a></li>
          ...
          <ul class="col">
            ...
            <li><a data-city-code="KUL" data-city-index="60" href="#">Kuala Lumpur <span>(KUL)</span></a></li>
            ...
            <li class="last"><a data-city-code="WLG" data-city-index="67" href="#">Wellington <span>(WLG)</span></a></li>
  ...
  <div class="clear"></div>
  <a href="/ticket/checking" class="subm"
